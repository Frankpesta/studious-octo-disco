			...
			<section className="py-16 md:py-24 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-950/20 dark:to-blue-950/20">
				<div className="container px-4 md:px-6">
					...
					<div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card>
							<CardHeader>
								<TrendingUp className="h-12 w-12 text-purple-600 dark:text-purple-400 mb-2" />
						...
						<Card>
							<CardHeader>
								<LineChart className="h-12 w-12 text-purple-600 dark:text-purple-400 mb-2" />
						...
						<Card>
							<CardHeader>
								<Lock className="h-12 w-12 text-purple-600 dark:text-purple-400 mb-2" />
